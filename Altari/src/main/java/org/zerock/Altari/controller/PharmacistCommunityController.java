...
public class PharmacistCommunityController {
    ...
    public ResponseEntity<PharmacistCommunityCommentDTO> createReplyComment(
            @RequestBody PharmacistCommunityCommentDTO commentDTO,
        ...
        // 대댓글 생성 서비스 호출
        PharmacistCommunityCommentDTO createdReplyComment = pharmacistCommunityCommentService.createReplyComment(user, parentCommentId, commentDTO);
